    ...
    static var tableModel = [
        PostSection(posts: [
            Post(title: "Tesla profit surge driven by record car deliveries",
                 author: "Elon Mask",
                 image: putFilterOnImage(UIImage(named: "tesla-model_y")!, .noir),
            ...
            Post(title: "The Suicide Squad: James Gunn taps into DC lore with new trailer starring Idris Elba, Margot Robbie, John Cena",
                 author: "James Gunn",
                 image: putFilterOnImage(UIImage(named: "Margot_Robbie")!, .fade),
            ...
            Post(title: "SpaceX lifts huge Super Heavy rocket onto launch stand",
                 author: "Elon Mask",
                 image: putFilterOnImage(UIImage(named: "Super_heavy_rocket")!, .colorInvert),
            ...
            Post(title: "BMW M3 Competition Takes on the Alfa Romeo Giulia Quadrifoglio Again",
                 ...
                 image: putFilterOnImage(UIImage(named: "G80-BMW-M3-vs-Alfa-Romeo-Giulia-Quadrifoglio-4-of-4")!, .bloom(intensity: 1.2)),
