...
//  Navigation
//
//  Created by GiN Eugene on 13/6/2022.
//
    ...
    static var tableModel = [
        PostSection(posts: [
            Post(title: "Tesla profit surge driven by record car deliveries",
                 author: "Elon Mask",
                 image: putFilterOnImage(UIImage(named: "tesla-model_y") ?? UIImage(), .chrome).pngData(),
            ...
            Post(title: "The Suicide Squad: James Gunn taps into DC lore with new trailer starring Idris Elba, Margot Robbie, John Cena",
                 author: "James Gunn",
                 image: putFilterOnImage(UIImage(named: "Margot_Robbie") ?? UIImage(), .fade).pngData(),
            ...
            Post(title: "SpaceX lifts huge Super Heavy rocket onto launch stand",
                 author: "Elon Mask",
                 image: putFilterOnImage(UIImage(named: "Super_heavy_rocket") ?? UIImage(), .colorInvert).pngData(),
            ...
            Post(title: "BMW M3 Competition Takes on the Alfa Romeo Giulia Quadrifoglio Again",
                 ...
                 image: putFilterOnImage(UIImage(named: "G80-BMW-M3-vs-Alfa-Romeo-Giulia-Quadrifoglio-4-of-4") ?? UIImage(), .bloom(intensity: 1.2)).pngData(),
